...
class NextFrameButton(ButtonClass):
    def __init__(self):
        super().__init__(x=210, y=SCREEN_HEIGHT-60, width=150, height=50, text="Next Frame")
        

class PreviousFrameButton(ButtonClass):
    def __init__(self):
        super().__init__(x=10, y=SCREEN_HEIGHT-60, width=150, height=50, text="Previous Frame")

class PlaySimulationButton(ButtonClass):
    def __init__(self):
        super().__init__(x=410, y=SCREEN_HEIGHT-60, width=150, height=50, text="Play Simulation")


class InputField(ButtonClass):
    def __init__(self):
        super().__init__(610, SCREEN_HEIGHT-60, 150, 50, text="")
        self.active = False
        self.input_text = ""
        self.color_inactive = LIGHTBLUE
